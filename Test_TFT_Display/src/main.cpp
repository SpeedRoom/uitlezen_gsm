...
unsigned long testText() {
  ...
  tft.setTextSize(3);
  tft.println("Man sterft na overmatig gebruik");
  tft.setTextSize(1);
  tft.println("Na het enorm veel snuiven door de neus,");
  tft.println("sterft M.M in de circoisa. Hij kreeg nog een orgasme hierbij");
